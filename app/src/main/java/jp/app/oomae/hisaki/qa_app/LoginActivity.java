...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataBaseReference = FirebaseDatabase.getInstance().getReference();//データベースへのリファレンスを取得
        ...
        Button createButton = (Button) findViewById(R.id.createButton);//新規作成ボタン
        ...
        Button loginButton = (Button) findViewById(R.id.loginButton);//ログインボタン
